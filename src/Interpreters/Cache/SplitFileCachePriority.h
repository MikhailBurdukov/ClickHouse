...
public:
    class SplitIterator;
    using CachePriorityCreatorFunction = std::function<IFileCachePriorityPtr(size_t max_size, size_t max_elements, double size_ratio, String description)>;
...
private:
    ...
    double data_segment_size_ratio;
...
public:
    ...
    QueueEntryType getType() const override { return type == FileSegmentKeyType::Data ? QueueEntryType::SplitCache_Data : QueueEntryType::SplitCache_System; }
